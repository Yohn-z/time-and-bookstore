...
demo = {
    ...
    initChartist: function(pie){
        ...
        Chartist.Line('#chartHours', dataSales, optionsSales, responsiveSales);
      	...
      	var data = {
      	        labels: ['日刊', '月刊', '年刊', '体育', '哲学', '文学', '物理', '计算机', '金融', '自然', '其他'],
      	        series: [
      	          [345, 123, 200, 580, 400, 120, 50, 360, 68, 400, 34],
        ...
        Chartist.Pie('#chartPreferences', pie);
    },
...
$(function () {
	$("body").on('click','#out',function(){
		var url = "/bookshophhit/user/userlogin/logout.action";
		$.ajax({
		  url:  url,
		  dataType: "json",
		  type:"post",
		  ...
		  error:function(data){
			  //demo.showNotification('bottom','center',4,"未知錯誤");
			  location.href = "index.html";
		  }
