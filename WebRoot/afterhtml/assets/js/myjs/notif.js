...
var userlist_url = "/bookshophhit/admin/letter/getAllbyuser.action";//请求用户列表
/*var userinfo_url = "../admin/letter/deleteLetterByid";//指定用户信息
*/
var deleteuserinfo_url = "/bookshophhit/admin/letter/deleteLetterByid.action";//删除
var adduser_url = "/bookshophhit/admin/letter/insertletter.action";//添加
var findmsg_url = "/bookshophhit/admin/letter/lettermsg.action"//查看信息
